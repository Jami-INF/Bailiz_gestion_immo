...
export function BailDetailPage() {
  ...
  if (!bail || !bien || !locataires) return null;
  ...
  return (
    <div>
      ...
      <Modal
        ...
        title="Signature du bail — deux voies possibles"
        footer={
          <>
            <Button variant="secondary" onClick={() => setModaleSignature(false)}>
              Annuler
            </Button>
            <Button onClick={confirmerSignature}>Confirmer la signature</Button>
          </>
        }
      >
        <div className="space-y-4 text-sm text-accent-700">
          ...
          <div className="rounded-lg border border-accent-200 p-4">
            ...
            <p>
              ...
              DocuSign…). Cette voie offre une valeur probante renforcée, recommandée pour le
              bail.
            </p>
          </div>
          <Field label="Date de signature effective">
